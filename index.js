...
restService.post("/sdpFailed", function(req, res) {
   var papers = [{ paperName: "comm501", sem: "both", description: "Applied Communication, the focus of communication in written, oral, interpersonal or group conditions", preReq: "no pre-requisites", year: "Year 1", coreq: "no co-requistes", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "comp500", sem: "both", description: "Programming One, introduction to the basics of programming", preReq: "no pre-requisites", year: "Year 1", coreq: "no co-requistes", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "comp501", sem: "both", description: "Computing Technology in Society, introduction to the evolution and application of computer systems", preReq: "no pre-requisites", year: "Year 1", coreq: "no co-requistes", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "comp502", sem: "both", description: "Foundations of IT Infrastructure, introduction to IT infrastructure concepts", preReq: "no pre-requisites", year: "Year 1", coreq: "no co-requistes", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "comp503", sem: "both", description: "Programming Two, Introduces the process of program design ", preReq: "Either Pre Requisite: comp500 or ense501", year: "Year 1", coreq: "no co-requistes", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "comp600", sem: "both", description: "IT project management, core competencies of project management in an information technology context.", preReq: "no pre-requisites", year: "Year 2", coreq: "no co-requisites", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 ...
                 { paperName: "comp609", sem: "both", description: "Issues, skills and strategies associated with providing core services over a network in a multi user environment.", preReq: "Pre Requisite: Either Pre-Requisites comp500 or enel504", year: "Year 2", coreq: "no co-requisites", sd: "none", ns: "-", iss: "none", cs: "none", ci: "none", als: "none"},
                 { paperName: "comp704", sem: "not determined", description: "Research and Development Project,  investigation into a selected area whether that be a specific problem domain, or an area of business opportunity.", preReq: "no pre-requisites", year: "Year 3", coreq: "no co-requisites", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 ...
                 { paperName: "comp714", sem: "both", description: " applies relevant theoretical models for the evaluation, selection and deployment of advanced network technologies providing specified services.", preReq: "Pre Requisite: comp609", year: "Year 3", coreq: "no co-requisites", sd: "none", ns: "-", iss: "none", cs: "none", ci: "none", als: "none"},
                 { paperName: "comp715", sem: "both", description: "Provides an in-depth understanding of LAN, WAN and Wireless security focusing on the functionality available and configuration of network and link layers.", preReq: "Pre Requisite: enel611", year: "Year 3", coreq: "no co-requisites", sd: "none", ns: "-", iss: "none", cs: "none", ci: "none", als: "none"},
                 ...
                 { paperName: "enel504", sem: "both", description: "Computer Network Principles, provides the knowledge and skills required to build a scalable switched and routed computer network.", preReq: "no pre-requisites", year: "Year 1", coreq: "no co-requistes", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "enel611", sem: "both", description: "To provide the knowledge and skills required to build a scalable switched and routed Wide Area Network.", preReq: "Pre Requisite: Either Pre-Requisites comp500 or enel504", year: "Year 2", coreq: "no co-requisites", sd: "none", ns: "-", iss: "none", cs: "none", ci: "none", als: "none"},
                 ...
                 { paperName: "infs500", sem: "both", description: "Enterprise Systems, An introduction to enterprise information systems", preReq: "no pre-requisites", year: "Year 1", coreq: "no co-requistes", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "infs600", sem: "both", description: "Data and Process Modelling, foundation in high-level computer graphics programming", preReq: "Either Pre Requisite: comp500 or ense501", year: "Year 2", coreq: "no co-requisites", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
                 { paperName: "infs601", sem: "both", description: "Logical Database Design, Provides students with the essential concepts, principles, and techniques of database management systems.", preReq: "Either Pre Requisite: comp500 or ense501", year: "Year 2", coreq: "no co-requisites", sd: "-", ns: "-", iss: "none", cs: "none", ci: "none", als: "none" },
